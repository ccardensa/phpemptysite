...
,'wsInitTransactionOutput'=>'wsInitTransactionOutput'
 ...
 {
    $this->soapClient = new mySoap('https://webpay3gint.transbank.cl/WSWebpayTransaction/cxf/WSWebpayService?wsdl', 
                                    array("classmap" => self::$classmap, "trace" => true, "exceptions" => true));
...
function initTransaction(initTransaction $initTransaction)
{
    ...
    try{
        ...
        $input->wSTransactionType = $initTransaction->wsInitTransactionInput->wSTransactionType;
        $input->buyOrder = $initTransaction->wsInitTransactionInput->buyOrder;
        $input->commerceId = $initTransaction->wsInitTransactionInput->commerceId;
        $input->finalURL = $initTransaction->wsInitTransactionInput->finalURL;
        $input->returnURL = $initTransaction->wsInitTransactionInput->returnURL;
        $input->sessionId = $initTransaction->wsInitTransactionInput->sessionId;
       
        
        return $initTransactionResponse = $this->soapClient->initTransaction($input)->return;           
